...
#'
#' \code{get_traveltime} is the main function of the traveltimeR package. It requests traveltime-isochrones from the traveltime platform, which supports several modes of transport in several countries.
#'
