...
ggmap(basemap2)+
   geom_sf(data=traveltime60,inherit.aes = FALSE, fill="grey", alpha=0.5, color=F)+
  geom_sf(data=traveltime30,inherit.aes = FALSE, fill="darkslategrey",alpha=0.5,color=F)+
  theme_void()+
  coord_sf(datum = NA)
