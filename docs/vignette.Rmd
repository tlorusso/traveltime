...
ggmap(basemap)+
  ...
  coord_sf(datum = NA)+
  scale_fill_viridis_d(name="minutes")+
  labs(title="Traveltimemap", subtitle="How far can you travel from a certain location within a given timeframe?", caption="data : traveltimeplatform.com")
